...
- [x] 52-01-PLAN.md — FeatureBuilder core: dataclasses + builder class + PIT registry

**Wave 2** *(blocked on Wave 1)*

- [x] 52-02-PLAN.md — Replace 4 inline feature construction copies with FeatureBuilder calls
