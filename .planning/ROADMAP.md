...
Plans:
- [ ] 27-01-PLAN.md -- 相対特徴量拡張 (オッズ相対+能力値相対) + FEATURE_COLS更新 (INTER-01)
- [ ] 27-02-PLAN.md -- 交互作用項12個 (既存3+新規9) + FEATURE_COLS更新 (INTER-02)
- [ ] 27-03-PLAN.md -- TargetEncoder新規モジュール + OOF安全TE + FEATURE_COLS更新 (INTER-03)
