...
### v1.6 Feature Engineering Overhaul (Shipped 2026-05-17)
...
- [x] **Phase 27: Feature Interactions** - 条件付き交互作用項 + ターゲットエンコーディング (3/3 plans, wave 1→2→3) (completed 2026-05-15)
- [x] **Phase 28: Validation & Freeze** - 統合バックテスト + ROI検証 + 特徴量凍結 (completed 2026-05-17)
...
- [x] 27-01-PLAN.md -- 相対特徴量拡張 (オッズ相対+能力値相対) + FEATURE_COLS更新 (INTER-01)
- [x] 27-02-PLAN.md -- 交互作用項12個 (既存3+新規9) + FEATURE_COLS更新 (INTER-02)
- [x] 27-03-PLAN.md -- TargetEncoder新規モジュール + OOF安全TE + FEATURE_COLS更新 (INTER-03)
...
- [x] 28-01-PLAN.md -- pytest回帰確認 + 特徴量凍結manifest生成 (autonomous)
- [x] 28-02-PLAN.md -- マルチ年度BT実行 + Feature importance再計算 + ROADMAP更新 (human-verify checkpoint)
