...
- [ ] **QUAL-03**: DeploymentGateEvaluator PASS (確率品質・ベット数維持・再現性・診断の4ゲート) — FAIL: per-fold Brier/logloss/ECEがbaselineより悪化
- [ ] **QUAL-04**: ROI回復傾向確認。必須条件: Brier/logloss/ECE非悪化、actual/predicted非悪化、ベット数維持。ROI 100%達成は目標だが必須条件ではない — FAIL: conservative MAWCはbaseline test ROIを下回りnot_deployable
...
| QUAL-01 | Phase 46 | Complete (PASS) |
| QUAL-02 | Phase 46 | Complete (PASS) |
| QUAL-03 | Phase 46 | Failed |
| QUAL-04 | Phase 46 | Failed |

**Coverage:**
- v2.2 requirements: 11 total
- Satisfied: 9
- Failed: 2 (QUAL-03, QUAL-04)
- Mapped to phases: 11
- Unmapped: 0

---
*Requirements defined: 2026-05-28*
*Closed: 2026-06-02 after Phase 46 runtime verification*
