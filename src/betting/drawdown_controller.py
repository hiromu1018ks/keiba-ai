...
class DrawdownController:
    ...
    MULTIPLIER_TABLE: list[tuple[float, float, float, float, float]] = [
        ...
        # ROI上限=999.99: 複勝の高オッズ（最大76倍）に対応
        (0.00, 0.10, 0.90, 999.99, 1.00),
        (0.00, 0.10, 0.00, 0.90, 0.75),
        (0.10, 0.15, 0.95, 999.99, 0.80),
        (0.10, 0.15, 0.00, 0.95, 0.50),
        (0.15, 0.20, 0.95, 999.99, 0.60),
        (0.15, 0.20, 0.00, 0.95, 0.30),
        (0.20, 0.25, 0.00, 999.99, 0.15),
        (0.25, 9.99, 0.00, 999.99, 0.05),  # 0.00→0.05: デッドロック防止
    ]
